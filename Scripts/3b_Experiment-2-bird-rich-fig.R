## --------------- HEADER ------------------------------------------------------
## Script name: 3b_Experiment-2-bird-rich-fig.R
...
d <- read.csv("Model-output/experiment-2-bird-rich-emmeans.csv")
...
ggsave("Figures/Experiment-2-bird-rich.png", width = 5, height = 7, units = "in")
